...
import com.clh.base.service.AdminService;
...
import com.clh.base.util.GsonUtil;
...
public class AdminController {
    ...
    public String editStudent(@PathVariable("user_id") int user_id, HttpSession session,Model model) {
    ...
    public String editDoctor(@PathVariable("doctor_id") int doctor_id, HttpSession session,Model model) {
