...
<form class="layui-form" style="width: 80%;">
    ...
    <input type="hidden" id="photo_path"  nadata-field="photo_path"me="photo_path" value="${hospital_user.photo_path}"/>
    ...
    <div class="layui-upload">
        ...
        <div class="layui-input-inline">
            ...
            <div class="layui-upload-list">
                <img class="layui-upload-img" src="../upload/${hospital_user.photo_path}" id="demo1" width="100px" height="100px">
                <p id="demoText"></p>
            </div>
        </div>
    </div>
