...
//下面四个时间选择器 改的很简单就是 后面的不能比前面的小就行了
    ...
    table.render({
        ...
        limits:[10,20,30,40],
        cols:[[
            {field:'user_id',title:'患者编号',align:'center',width:180},
            {field:'photo_path',title:'患者头像',align:'center',width:160,templet: "#imgtmp"},
            {field:'username',title:'患者用户名',align:'center',width:110},
            {field:'realname',title:'患者真实姓名',align:'center',width:150},
