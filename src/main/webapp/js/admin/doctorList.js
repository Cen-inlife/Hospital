...
//下面四个时间选择器 改的很简单就是 后面的不能比前面的小就行了
    ...
    table.render({
        ...
        limits:[10,20,30,40],
        cols:[[
            {field:'doctor_id',title:'医生编号',align:'center',width:200},
            {field:'photo_path',title:'医生头像',align:'center',width:200,templet: "#imgtmp"},
            {field:'username',title:'医生用户名',align:'center',width:110},
            {field:'realname',title:'医生真实姓名',align:'center',width:180},
